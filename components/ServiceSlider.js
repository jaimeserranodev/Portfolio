  ...
  >
    {
      serviceData.map((item, index) => {
        ...
        <SwiperSlide key={index}>
          <div className="bg-cyan-800 h-max rounded-lg px-6 py-8 flex sm:flex-col gap-x-6 sm:gap-x-0 group cursor-pointer hover:bg-[rgba(89,65,169,0.5)] transition-all duration-300">
            {/* icon */}
